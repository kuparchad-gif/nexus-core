...
print("✅ Core Genesis skills loaded into Nova Prime.")

# 🚨 Billing Safety Layer
class BillingGuardian:
    def __init__(self):
        self.authorized = os.getenv("NOVA_BILLING_UNLOCK", "false").lower() == "true"
        self.daily_limit = int(os.getenv("NOVA_DAILY_API_LIMIT", "10"))  # Default 10 calls max
