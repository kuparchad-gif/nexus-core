# Systems/nexus_core/heart/NovaCouncil/council_ledger.py
...
class CouncilLedger:
    ...
    def ensure_keys_exist(self):
        ...
        priv_key_path = os.path.join(self.keys_dir, "nova_private.pem")
        pub_key_path = os.path.join(self.keys_dir, "nova_public.pem")
