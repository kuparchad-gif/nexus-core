...
CRITICAL_SERVICES = [
    {"name": "lilith Prime Core", "healthcheck_url": "http://localhost:8080/"},
...
def attempt_self_heal():
    ...
    print("🛠️ Initiating lilith Prime self-heal attempt...")
...
def lilith_self_heal_daemon():
    """Daemon that checks health and auto-repairs if broken."""
    print("🧬 lilith Self-Heal Daemon running...")
